...
#Discord
tellraw @s ["",{"translate":"lem.relog.join.discord","fallback":"Come join the Community Server to talk about LEM, ask for help, find groups to play with and see development updates!","color":"#7289DA"},"\n",{"text":"https://discord.gg/sApDDaS8et","underlined":true,"color":"blue","clickEvent":{"action":"open_url","value":"https://discord.gg/sApDDaS8et"},"hoverEvent":{"action":"show_text","contents":[{"translate":"lem.relog.join.discord.hover","fallback":"Click to open","color":"blue"},": https://discord.gg/sApDDaS8et"]}}]
#ModTools
